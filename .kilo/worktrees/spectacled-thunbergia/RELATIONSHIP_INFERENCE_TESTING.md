...
1. Find host `esagex11.eswine.adds`
...
✓ Host 'esagex11.eswine.adds' is member of cluster: CLS.AGE
...
2. Search finds host: esagex11.eswine.adds
...
```
Query: "show me VMs in host esagex11"
Result: "I can see the hypervisor record for esagex11.eswine.adds, but the 
