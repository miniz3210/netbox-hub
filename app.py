...
st.caption("Device Types | Module Types | Rack Types | Images | Excel Engine | IPAM Provisioning | Naming Standards | OmniRoute AI")
...
with t6: render_ipam_tab(active_model)
with t7: render_naming_tab(active_model)
with t8: render_standards_tab(active_model)